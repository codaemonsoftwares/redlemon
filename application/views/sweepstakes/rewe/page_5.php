...
<html lang="de">
	<head>
		<title></title>
		<link href="<?php echo base_url() . "public/sweepstakes/rewe/"; ?>css/page_5.css" type="text/css" rel="stylesheet">
	...
	<body>
		<div id="content">
			...
			<div id="main">		
				<p class="big_text">Als Dankesch&ouml;n w&auml;hlen Sie aus diesen Angeboten:</p>
			</div>
