 ...
 */
/*
 * SUBODH :: Use $this->mongo_db instance for accessign
 * */
class Mongo_db
{
	...
	*/
	...
	private function _connect()
	{
		...
		try
		{  
			//$this->_connection = new Mongo($this->_connection_string, $options);	 // SUBODH :: Commented
			$this->_connection = new Mongo($this->_connection_string); 		
	...
	{		
		...
		//$connection_string = 'mongodb://'; // SUBODH :: Commented 
		$connection_string = "";		
		if (empty($this->_host))
		{
